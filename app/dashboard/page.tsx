        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              {/* Logout button can just redirect or be removed */}
              <button
                // onClick={() => {
                //   // Perform logout logic here if any, otherwise just redirect
          ...
          <div className="p-8 text-center">
            <div className="mx-auto h-24 w-24 mb-6 relative">
              <Image
                ...
                alt={`${userData?.data.first_name} ${userData?.data.last_name}` || 'User avatar'}
                fill
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">
              {userData ? `${userData.data.first_name} ${userData.data.last_name}` : 'Guest User'}
            </h2>

            <p className="text-sm text-gray-500 mb-6">{userData?.data.email || 'No email available'}</p>
